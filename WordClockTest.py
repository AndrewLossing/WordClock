...
#Trigger changes to clock LEDs every minute
    ...
    if [datetime.datetime.now().month, datetime.datetime.now().day] in HeartTrigger and \
            next_call.minute % 5 == 4:
        Heart(strip_param, red)

    elif [datetime.datetime.now().month, datetime.datetime.now().day] in CakeTrigger and \
            next_call.minute % 5 == 3:
        Cake(strip_param, 30)
